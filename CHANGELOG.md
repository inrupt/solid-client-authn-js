...
- Added a `EVENTS.AUTHORIZATION_REQUEST_STATE` (`authorizationRequestState`) event that emits authentication state during login to support clustered deployments.
